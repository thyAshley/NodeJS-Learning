...
var stripe = Stripe('pk_test_edNW5gMjscA4Rnj5nwaItZ5A00REYqHtc9');
...
if (passwordform) {
  passwordform.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var password, newPassword, passwordConfirm, saveBtn;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              password = passwordform.querySelector('input[name="curPassword').value;
              newPassword = passwordform.querySelector('input[name="newPassword').value;
              passwordConfirm = passwordform.querySelector('input[name="cfmPassword').value;
